...
import (
	...
	client2 "github.com/turfaa/vmedis-proxy-api/vmedis"
	"gorm.io/gorm"
)
...
func DumpProcurementRecommendations(ctx context.Context, db *gorm.DB, redisClient *redis.Client, vmedisClient *client2.Client) {
...
func calculateRecommendation(stock client2.DrugStock, drugUnits []models.DrugUnit) (chosen schema.Stock, alternatives []schema.Stock) {
