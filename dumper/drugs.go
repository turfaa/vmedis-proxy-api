...
func DumpDrugs(ctx context.Context, db *gorm.DB, vmedisClient *vmedis.Client, detailsPuller chan<- models.Drug) {
...
func DrugDetailsPuller(ctx context.Context, db *gorm.DB, vmedisClient *vmedis.Client) (chan<- models.Drug, func()) {
