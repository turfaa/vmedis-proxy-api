...
func (c *Client) GetTodaySales(ctx context.Context, page int) (SalesResponse, error) {
	res, err := c.get(ctx, fmt.Sprintf("/apt-lap-penjualanobat-batch/index?AptLapPenjualanobatBatchSearch%5Bcari%5D=4&AptLapPenjualanobatBatchSearch%5Bbulan%5D=Dec+2023&AptLapPenjualanobatBatchSearch%5Btahun%5D=2023&AptLapPenjualanobatBatchSearch%5Btanggalawal%5D=21+Dec+2023&AptLapPenjualanobatBatchSearch%5Btanggalakhir%5D=23+Dec+2023++++&AptLapPenjualanobatBatchSearch%5Bstruk%5D=2&AptLapPenjualanobatBatchSearch%5Bpjjumlahcetak%5D=&AptLapPenjualanobatBatchSearch%5Bshfkode%5D=&AptLapPenjualanobatBatchSearch%5Busername%5D=&AptLapPenjualanobatBatchSearch%5Bpjnofaktur%5D=&AptLapPenjualanobatBatchSearch%5Bobatkode%5D=&AptLapPenjualanobatBatchSearch%5Bobatnama%5D=&AptLapPenjualanobatBatchSearch%5Bpjdnobatch%5D=&AptLapPenjualanobatBatchSearch%5Bpjresep%5D=&AptLapPenjualanobatBatchSearch%5Bpasnama%5D=&AptLapPenjualanobatBatchSearch%5Bdoknama%5D=&AptLapPenjualanobatBatchSearch%5Bpjsales%5D=&AptLapPenjualanobatBatchSearch%5Bpjjenis%5D=&AptLapPenjualanobatBatchSearch%5Bpjsoanama%5D=&AptLapPenjualanobatBatchSearch%5Bpjfakturpajak%5D=&AptLapPenjualanobatBatchSearch%5Bpjpromo%5D=&page=%d", page))
	if err != nil {
